...
<html> 
    ...
    <head>
        ...
        <title>Shopper's Central User Home</title>
    </head>
    ...
    <body style="background-color:white;margin:0px;padding:0px;border:0px;">
        ...
        <div class="main">
         <div class="innerdiv" style="padding-top:10px;height:430px;">
        ...
        <table border="0" width="300">
            ...
            <tr> 
            <td colspan="3" width="200" align="left"><a href="${base}/searchController.htm?type=Electronics&emailId=${email}">Show more...</a>
            <br/></td>
            </tr>
        </table></div>
         <div class="innerdiv" style="padding-top:10px;height:430px;">
        ...
        <table border="0" width="300">
            ...
            <tr>
             ...
             <tr> 
            <td colspan="3" width="200" align="left"><a href="${base}/searchController.htm?type=Clothing&emailId=${email}">Show more...</a>
            <br/></td>
            </tr>
        </table>
        </div>
        ...
        <table border="0" width="300">
            ...
            <tr> 
            <td colspan="3" width="200" align="left"><a href="${base}/searchController.htm?type=Books&emailId=${email}">Show more...</a>
            <br/></td>
            </tr>
        </table>
        </div >
